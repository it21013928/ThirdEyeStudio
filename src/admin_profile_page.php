    ...
    <?php session_start();
        ...
        if(isset($_SESSION['username'], $_SESSION['role'])) {
            if($_SESSION['role']=="admin"){
                ...
                $sql = "select AdministratorID, First_name from Administrator where Username='".$username."'";
    ...
    <div class="row">
        <div class="column">
            <div class="head-nav-item">
                <p>Home > Profile > Admin</p>
            </div>
            <h2 class="nav-header-text">Admin Profile</h2>
            <div class="row">
                ...
                <div class="profile-col-two" >
                    ...
                    <p class="profile-navbar"> <a href="photographer_list_page.php">Photographers</a> | <a href="editor_list_page.php">Editors</a> | <a href="event_manager_list_page.php">Managers</a> | <a href="add_employee_page.php">Add employee</a></p>
                </div>
            </div>
            <h2 class="nav-header-text">All Events</h2>
            <div class="row">
                <?php
                        $sql = "select b.BookingID, e.EventID, c.First_name, e.Event_type, p.Name, b.event_date, b.Payment_state, b.Progress 
                        from booking b, event_tb e, package p, Client c
                        where b.ClientID = c.ClientID and e.EventID = b.EventID and p.PackageID = b.PackageID";
                        $result = $con->query($sql);
