    ...
    <div class="row">
        <div class="column">
            <div class="head-nav-item">
                <p>Home > Profile > Admin > Editors</p>
            </div>
            <h2 class="nav-header-text">Editors</h2>
            <div class="row">
                            ...
                            while($row = $result->fetch_assoc()){
                                echo "<div class='four-col-profile'>
                                        <center>
                                            ...
                                            <a href = 'editor_list_page.php?addorremove=remove&employeeid=".$row['EmployeeID']."'><button class='btn-view-profile'>Remove Profile</button></a>
                                        </center>
                                    </div>";
                            }
                        }
