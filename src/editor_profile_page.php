    ...
    <div class="row">
        <div class="column">
            <div class="head-nav-item">
                <p>Home > Profile > Editor</p>
            </div>
            <h2 class="nav-header-text">Editor Profile</h2>
            <div class="row">
            ...
            <div class="row">
                    <?php
                        ...
                        where b.ClientID = c.ClientID and ev.EventID = b.EventID and p.PackageID = b.PackageID and be.EmployeeID = ".$editorid." and be.BookingID = b.BookingID and be.EmployeeID = em.EmployeeID";
                        $result = $con->query($sql);
